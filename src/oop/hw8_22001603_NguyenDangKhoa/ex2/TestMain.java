...
import hw8_22001603_NguyenDangKhoa.ex2.DirectedWeightedGraph;
...
public class TestMain {
    public static void main(String[] args) {
        ...
        // Test outgoingEdges
        System.out.println("Cạnh di từ A:");
        ...
        System.out.println("Đỉnh cuối của cạnh edge1: " + endVertices[0].getValue() + ", " + endVertices[1].getValue());

        // Test opposite
        Vertex<String> oppositeVertex = graph.opposite(vertexA, edge1);
        System.out.println("Đỉnh đối diện của A trong edge1: " + oppositeVertex.getValue());
