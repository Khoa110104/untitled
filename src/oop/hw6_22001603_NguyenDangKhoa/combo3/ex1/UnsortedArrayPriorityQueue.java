...
public class UnsortedArrayPriorityQueue<K extends Comparable, E> implements PriorityQueueInterface<K, E> {
    ...
    public hw6_22001603_NguyenDangKhoa.combo3.ex1.Entry<K, E> removeMin() {
        ...
        hw6_22001603_NguyenDangKhoa.combo3.ex1.Entry<K, E> minEntry = array[minIndex];
    ...
    public hw6_22001603_NguyenDangKhoa.combo3.ex1.Entry<K, E> min() {
        ...
        hw6_22001603_NguyenDangKhoa.combo3.ex1.Entry<K, E> minEntry = array[0];
        K minKey = array[0].getKey();
        for (int i = 1; i < n; i++) {
            K currentKey = array[i].getKey();
            if (currentKey.compareTo(minKey) < 0) {
    ...
    public class ArrEntry<K, E> implements hw6_22001603_NguyenDangKhoa.combo3.ex1.Entry<K, E> {
        K key;
        E element;
