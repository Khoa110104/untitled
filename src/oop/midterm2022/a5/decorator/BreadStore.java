...
public class BreadStore {
    ...
    public static void main(String args[]) {
         ...
         */
        /* TODO */
        breadStore.add(new Cheese(new Cheese(new Olives(new ThincrustBread()))));
        breadStore.add(new Cheese(new Olives(new Olives(new ThincrustBread()))));
        breadStore.add(new Cheese(new Cheese(new ThincrustBread())));
        System.out.println("After add:");
        breadStore.print();

        breadStore.sell(new Cheese(new Olives(new Olives(new ThincrustBread()))));
        breadStore.add(new Cheese(new Cheese(new ThincrustBread())));
        ...
        List<Bread> lostCostBreads = breadStore.filter(5, false);
        for (Bread bread : lostCostBreads) {
            System.out.println(bread.getDescription() + ", cost = " + bread.cost());
