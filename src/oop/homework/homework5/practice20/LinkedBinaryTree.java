...
import homework.homework5.practice20.BinaryTreeInterface;
...
public class LinkedBinaryTree<E, T> implements BinaryTreeInterface<T> {
    ...
    public static void main(String[] args) {
        ...
        LinkedBinaryTree<Integer, Node<Integer>> linkedTree = new LinkedBinaryTree<>();
        linkedTree.root = linkedTree.addRoot(1);
        Node<Integer> L = linkedTree.addLeft(linkedTree.root, 2);
        Node<Integer> R = linkedTree.addRight(linkedTree.root, 3);
        Node<Integer> RL = linkedTree.addLeft(R, 6);
        Node<Integer> LL = linkedTree.addLeft(L, 4);
        Node<Integer> LR = linkedTree.addRight(L, 5);
        String fileName = "C:\\Learning\\java1\\dsa\\src\\homework\\homework5\\practice20\\output.txt";
