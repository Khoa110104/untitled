...
import homework.homework1.BookStore.Book;
...
public class BookManager {
    ...
    private ArrayList<homework.homework1.BookStore.Book> listMyBook = new ArrayList<>();
    private ArrayList<homework.homework1.BookStore.Book> allBook = new ArrayList<>();
    ...
    public BookManager() {
        ...
        try {
            ...
            while (input.hasNext()) {
                ...
                homework.homework1.BookStore.Book book = new homework.homework1.BookStore.Book(title, author, type, cost);
    ...
    public void printStoreBookByFilter(ArrayList<homework.homework1.BookStore.Book> list) {
        for (homework.homework1.BookStore.Book book : list) {
    ...
    public void printAllBook() {
        ...
        int index = 0;
        for (homework.homework1.BookStore.Book book : allBook) {
            System.out.println(++index + "." + book);
        }
        System.out.println();
    }

    public ArrayList<homework.homework1.BookStore.Book> sortBook(String category) {
        ArrayList<homework.homework1.BookStore.Book> filterList = new ArrayList<>();
        for (homework.homework1.BookStore.Book book : allBook) {
    ...
    public ArrayList<homework.homework1.BookStore.Book> getAllBook() {
        return allBook;
    }

    public ArrayList<homework.homework1.BookStore.Book> buyBook(int index) {
    ...
    public ArrayList<homework.homework1.BookStore.Book> getListMyBook() {
        return listMyBook;
    }
    ...
    public void printMyListBook() {
        if (listMyBook.size() == 0) {
            ...
            int index = 0;
            for (homework.homework1.BookStore.Book book : listMyBook) {
                System.out.println(++index + " " + book);
            }
        }
    }
        ...
        for (int i = 0; i < allBook.size() - 1; i++) {
            for (int j = i + 1; j < allBook.size(); j++) {
                if (allBook.get(j).getTitle().compareTo(allBook.get(i).getTitle()) < 0) {
                    homework.homework1.BookStore.Book temp = allBook.get(i);
    ...
    public BookManager updateBook() {
        ...
        for (int i = 0; i < amount; i++) {
            ...
            int cost = Integer.parseInt(input.nextLine());
            homework.homework1.BookStore.Book book = new Book(nameBook, nameAuthor, type, cost);
