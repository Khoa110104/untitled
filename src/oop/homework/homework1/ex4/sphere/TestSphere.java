package oop.homework.homework1.ex4.sphere;

import homework.homework1.ex4.sphere.Sphere;
...
public class TestSphere {
    public static void main(String[] args) {
        ...
        homework.homework1.ex4.sphere.Sphere sphere1 = homework.homework1.ex4.sphere.Sphere.inputSphere();
        ...
        homework.homework1.ex4.sphere.Sphere sphere2 = homework.homework1.ex4.sphere.Sphere.inputSphere();
        ...
        switch (choice) {
            case 1:
                ...
                if (homework.homework1.ex4.sphere.Sphere.isContain(sphere1, sphere2)) {
                    System.out.println("The two spheres contain each other.");
                } else if (homework.homework1.ex4.sphere.Sphere.isIntersect(sphere1, sphere2)) {
                    System.out.println("The two spheres intersect.");
                } else if (homework.homework1.ex4.sphere.Sphere.internalContact(sphere1, sphere2)) {
